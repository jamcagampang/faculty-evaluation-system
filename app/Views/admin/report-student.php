                ...
                <li>
                    <div class="menu">
                        ...
                        <div class="sub-menu" style="display: block;">
                            ...
                            <a href="/admin/report/student" class="sub-item active"> Student Evaluation </a>
                        </div>
                    </div>
                </li>
            </ul>
            ...
            <div class="container">
                ...
                <div class="card">
                    <div style="padding-top:10px" class="card-body">
                        ...
                        <select id="selection2" class="custom-select" name="course">
                            <?php if ($courses) : ?>
                                <?php foreach ($courses as $c) : ?>
                                    <option value="<?php echo $c['id']; ?>" <?php if ($c['s']) echo 'selected' ?>><?php echo $c['course_name'] . ' (' . $c['course_code'] . ')'; ?></option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
...
<script>
    $('document').ready(function(e) {
        $('#selection').change(function(e) {
            location.href = '/admin/report/student/' + $('#selection').val();
        });
        $('#selection2').change(function(e) {
            location.href = '/admin/report/student/' + $('#selection').val() + '/' + $('#selection2').val();
        });
    });
</script>
