				...
				<li>
					<div class="menu">
						...
						<div class="sub-menu" style="display: block;">
							<a href="/admin/faculty/add" class="sub-item active"> Faculty </a>
                ...
                <div id="loginbox" style="margin-top:10px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:10px" class="panel-body">
                            ...
                            <form id="loginform" class="form-horizontal" role="form" method="POST" action="<?= site_url('/admin/faculty/add') ?>">
                                ...
                                <div style="margin-bottom: 10px" class="input-group">
                                    ...
                                    <select class="form-control" name="designation" placeholder="Designation" style="height: 38.99306px;width: 503.99306px;">
                                        <option disabled selected hidden>Designation</option>
                                        <option value="ftf"> Full-time Faculty </option>
                                        <option value="ptf"> Part-time Faculty </option>
                                    </select>
                                </div>
                                ...
                                <div style="margin-bottom: 10px" class="input-group">
                                    ...
                                    <select class="form-control" name="department" placeholder="Department" style="height: 38.99306px;width: 503.99306px;">
                                        <option value="" disabled selected hidden>Department</option>
                                        <option value="gs"> Grade School </option>
                                        <option value="jhs"> Junior High School </option>
                                        <option value="shs"> Senior High School </option>
                                        <option value="iba"> Institute of Business Administration </option>
                                        <option value="ics"> Institute of Copumter Studies </option>
                                        <option value="ieas"> Institute of Education, Arts and Sciences </option>
                                        <option value="ihmac"> Institute of Hospitality Management and Allied Courses </option>
                                        <option value="in"> Institute of Nursing </option>
                                    </select>
                                </div>
