                ...
                <li>
                    <div class="menu">
                        ...
                        <div class="sub-menu" style="display: block;">
                            ...
                            <a href="/admin/student/assign" class="sub-item active"> Assign Student to Courses </a>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <div id="loginbox" style="margin-top:10px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:10px" class="panel-body">
                            ...
                            <form id="loginform" class="form-horizontal" role="form" method="POST" action="<?= site_url('/admin/student/assign') ?>">

                                <div style="margin-bottom: 10px" class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>

                                    <select class="form-control" name="student" placeholder="Student" style="height: 38.99306px;width: 503.99306px;">
                                        <option disabled selected hidden value="0">Student</option>
                                        <?php if ($students) : ?>
    ...
    <script>
        $(document).ready(function(e) {
            <?php if (isset($student) && isset($course)) : ?>
                alert('<?php echo $course?>' + ' has been successfully assigned to ' + '<?php echo $student?>' + '.');
            <?php endif; ?>
        });
    </script>
